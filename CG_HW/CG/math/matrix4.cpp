...
matrix4::matrix4(const matrix4& mat)					{ memcpy(this, &mat, sizeof(matrix4));}
matrix4::matrix4()
{
 	setIdentityRot();
}
...
{
	return 
		isSimilar(_11,other._11) &&		
		isSimilar(_12,other._12) &&		
		isSimilar(_13,other._13) &&		
		isSimilar(_14,other._14) &&		
		isSimilar(_21,other._21) &&		
		isSimilar(_22,other._22) &&		
		isSimilar(_23,other._23) &&		
		isSimilar(_24,other._24) &&		
		isSimilar(_31,other._31) &&		
		isSimilar(_32,other._32) &&		
		isSimilar(_33,other._33) &&		
		isSimilar(_34,other._34) &&		
		isSimilar(_41,other._41) &&		
		isSimilar(_42,other._42) &&		
		isSimilar(_43,other._43) &&		
		isSimilar(_44,other._44) 	;	
}

void matrix4::getCurrentOpenGLmatrix(int type)
{
	glGetDoublev(type, (double*)&_11);
	// transpose the result. 
	// This is necessary because OpenGL assumes column-major matrix (fortran standard). 
	// but matrix4 uses row-major (C standard).
	transpose();
}
vector3 matrix4::getTranslation() const { vector3 o; o.translation(*this); return o;}
const double* matrix4::GLmatrix() const
{
	// transpose this
	// This is necessary because OpenGL assumes column-major matrix (fortran standard). 
	// but matrix4 uses row-major (C standard).
...
void matrix4::setValue( double x00, double x01, double x02,
...
void matrix4::setValue( double x00, double x01, double x02, double x03,
...
void matrix4::setRotation(const vector3& axis, double angle, bool bPreserveCurrentTranslation)
{
#ifdef USE_D3DFUNC
	D3DXMATRIX dxmat;
