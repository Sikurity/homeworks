...
; (588kbytes) is set aside to be used for launching "LEEYSOS" image file.
;===============================================================================
...
.read_next_fat_dir:
		...
		; find leeys os image file from directory table
		mov		cx, 224
		mov		bx, 1400h
...
.load_kernel:
		...
		mov		ax, LDRSEG
		mov		ds, ax
		jmp		LDRSEG:1000h			; jump to leeysos
...
;===============================================================================
msg_loading	db	'LEEYSOS LOADING.........', 00h
msg_dot		db	'.', 00h
msg_error	db	'Error! Do Not Read....', 00h
str_kernel	db	'LEEYSOS BIN'
